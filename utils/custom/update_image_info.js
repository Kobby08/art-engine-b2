...
function update_image_info(cid) {
  ...
  console.log(
    `Updated Base URI for images to ===> ${NFT_DETAILS.imageFilesBase}`
  );
}

// update_image_info(
//   "bafybeidt2eey4ymyx4dl564ricb73cshwcys7hbg7covx2c245cia27q6u"
// );
