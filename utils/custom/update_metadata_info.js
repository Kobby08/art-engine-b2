...
const {
  ACCOUNT_DETAILS,
} = require(`${FOLDERS.constantsDir}/account_details.js`);
...
function update_metadata_info(cid) {
  ...
  console.log(
    `Updated Base URI for metadata JSON to ===> ${NFT_DETAILS.metaDataJSONFilesBase} and created ipfsMetas folder and json data files`
  );
}
